...
public class DFragment extends Fragment {
    ...
    private  String uri_Sports = " https://newsapi.org/v2/top-headlines?country=in&category=Sports&apiKey=9473e83029a540c99eaae443015416e5";
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.idRecycleViewD);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        processing(uri_Sports);
    }
