...
public class EFragment extends Fragment {
    ...
    private  String uri_Business = " https://newsapi.org/v2/top-headlines?country=in&category=Business&apiKey=9473e83029a540c99eaae443015416e5";
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.idRecycleViewE);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        processing(uri_Business);
    }
