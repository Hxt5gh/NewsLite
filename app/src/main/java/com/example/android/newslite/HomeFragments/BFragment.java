...
public class BFragment extends Fragment {
    ...
    private String url_Health = " https://newsapi.org/v2/top-headlines?country=in&category=Health&apiKey=9473e83029a540c99eaae443015416e5";
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.idRecycleViewB);
